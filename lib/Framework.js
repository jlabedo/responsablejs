...
var Framework = function () {
  ...
  _createClass(Framework, [{
    ...
    value: function serve(opts) {
      ...
      var port = _opts$port === undefined ? 3000 : _opts$port;
      ...
      var webpackOptions = {
        entry: ['webpack-hot-middleware/client?path=' + publicPath + '__webpack_hmr', 'webpack/hot/only-dev-server', _path2.default.join(__dirname, 'frontend-main.js')],
        output: {
          path: '/dist/',
        ...
        resolve: {
          ...
          alias: {
            ...
            'responsable$': _path2.default.join(__dirname, './FrameworkClient.js'),
        ...
        module: {
          ...
          }, { test: /\.woff(\?v=\d+\.\d+\.\d+)?$/, loader: 'url?limit=10000&mimetype=application/font-woff' }, { test: /\.woff2(\?v=\d+\.\d+\.\d+)?$/, loader: 'url?limit=10000&mimetype=application/font-woff' }, { test: /\.ttf(\?v=\d+\.\d+\.\d+)?$/, loader: 'url?limit=10000&mimetype=application/octet-stream' }, { test: /\.eot(\?v=\d+\.\d+\.\d+)?$/, loader: 'file' }, { test: /\.svg(\?v=\d+\.\d+\.\d+)?$/, loader: 'url?limit=10000&mimetype=image/svg+xml' }]
        },
